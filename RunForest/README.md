## Instructions to run the L1Emulator + HIForest with the Run 3 HI menu using CMSSW_12_3_0
...
git cms-merge-topic CmsHI:forest_CMSSW_12_3_0
...
```
cp L1StudiesFramework/RunForest/forestL1_miniAOD_2018Data.py CMSSW_12_3_0/src
cd CMSSW_12_3_0/src
...
```
cp L1StudiesFramework/RunForest/forestL1_miniAOD_Run3MC.py CMSSW_12_3_0/src
cd CMSSW_12_3_0/src
...
```
cp L1StudiesFramework/RunForest/crabConfig_2018Data_ForestL1.py CMSSW_12_3_0/src
cd CMSSW_12_3_0/src
...
```
cp L1StudiesFramework/RunForest/crabConfig_Run3MC_ForestL1.py CMSSW_12_3_0/src
cd CMSSW_12_3_0/src
