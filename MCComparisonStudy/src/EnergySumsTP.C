...
int Compare(char const* oldInput, char const* newInput) {
    ...
    canvas->Print("L1EnergySumsEmulated.pdf[");
    ...
    for (size_t i = 0; i < size; ++i) {
        ...
        PrintHist(newEnergySumHist, oldEnergySumHist, EnergySum[i], canvas, legend, "L1EnergySumsEmulated.pdf");
    }
    ...
    canvas->Print("L1CaloTPEmulated.pdf[");
    canvas->SetLogy(1);
    canvas->Clear();

    PrintHist(newCaloNTowersHist, oldCaloNTowersHist, "nTowers", canvas, legend, "L1CaloTPEmulated.pdf");
    PrintHist(newCaloIHBHist, oldCaloIHBHist, "HB Sum", canvas, legend, "L1CaloTPEmulated.pdf");
    PrintHist(newCaloIHEHist, oldCaloIHEHist, "HE Sum", canvas, legend, "L1CaloTPEmulated.pdf");
    PrintHist(newCaloIHFHist, oldCaloIHFHist, "HF Sum", canvas, legend, "L1CaloTPEmulated.pdf");

    PrintHist(newCaloNTowersHistZoom, oldCaloNTowersHistZoom, "nTowers", canvas, legend, "L1CaloTPEmulated.pdf");
    PrintHist(newCaloIHBHistZoom, oldCaloIHBHistZoom, "HB Sum", canvas, legend, "L1CaloTPEmulated.pdf");
    PrintHist(newCaloIHEHistZoom, oldCaloIHEHistZoom, "HE Sum", canvas, legend, "L1CaloTPEmulated.pdf");
    PrintHist(newCaloIHFHistZoom, oldCaloIHFHistZoom, "HF Sum", canvas, legend, "L1CaloTPEmulated.pdf");

    canvas->Print("L1CaloTPEmulated.pdf]");

    canvas->Print("L1CaloTPEtaPhiEmulated.pdf[");
    canvas->SetLogy(0);
    canvas->Clear();

    PrintHistProf2D(newCaloIHadEtaPhiHist, oldCaloIHadEtaPhiHist, canvas, "L1CaloTPEtaPhiEmulated.pdf");
