...
Output: A list of how many times the trigger L1_SingleJet60_BptxAND was passed
...
int Print(char const* input) {
    ...
    if (menu.Map().count("L1_SingleJet60_BptxAND")) {
        cout << "Emulation has passed L1_SingleJet60_BptxAND (" << menu.Map()["L1_SingleJet60_BptxAND"] << ") " << emuCounts[menu.Map()["L1_SingleJet60_BptxAND"]]
            << " times" << endl;
    }
    else {
        cout << "Error: L1_SingleJet60_BptxAND does not exist in the menu" << endl;
    }
